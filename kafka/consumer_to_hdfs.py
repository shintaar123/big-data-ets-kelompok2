    ...
    try:
        ...
        subprocess.run(
            [
                ...
                "hdfs", "dfs", "-put", "-f",
                container_tmp, f"{hdfs_path}/{filename}",
            ],
            check=True,
            capture_output=True,
        )
...
def consume():
    ...
    while True:
        ...
        try:
            ...
            print("[INFO] Kafka consumer terhubung, mulai polling...")
            while True:
                # poll() jauh lebih stabil di Windows vs iterasi langsung
